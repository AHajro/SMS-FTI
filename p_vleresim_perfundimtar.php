...
<script src="js/v_perfundimtar.js"></script>
<style>
.dataTables_filter {
display: none; 
}
...
<div class="container">	
	...
	<div class="content">
		<div class="container-fluid">
			<strong>Vleresimi Perfundimtar i Studentit</strong>
			<div class="row">
				<div class="col-md-12">
							...
							<div class="box-body">						
								...
								<div class="col-md-2">
										<div class="form-group">
											<label for="niveliId">Niveli i studimit</label><small class="req"> *</small>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="degaId">Dega</label><small class="req"> *</small>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="classid">Viti</label><small class="req"> *</small>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="sectionid">Grupi</label><small class="req"> *</small>
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="lendaid">Lenda</label><small class="req"> *</small>
			...
			<div class="row">					
				<form id="attendanceForm" method="post">					
					...
					<button type="submit" id="saveAttendance" name="saveAttendance" value="Save Attendance" style="margin-bottom:10px;" class="btn btn-danger btn-sm  pull-right checkbox-toggle hidden"><i class="fa fa-save"></i>Ruaj</button>
					 <table id="studentList" class="table table-bordered table-striped hidden">
						<thead>
							<tr>
								<th>Emri</th>
								<th>Mbiemri</th>	
								<th>Piket e Laboratorit</th>	
