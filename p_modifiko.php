...
if(!empty($_POST["update"]) && $_POST["update"]) {
	$message = $school->editAccountPedagog();
}
$userDetail = $school->userDetailsPedagog();
				...
				<form class="form-horizontal" role="form" method="POST" action="">				
					...
					<div class="form-group">						                                  
						<div class="col-md-offset-3 col-md-9">
							<button id="btn-signup" type="submit" name="update" value="update_account" class="btn btn-info"><i class="icon-hand-right"></i>Ruani Ndryshimet</button>			
						</div>
					</div>							
				</form>
			 </div>
