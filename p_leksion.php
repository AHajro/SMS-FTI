...
<script src="js/leksion.js"></script>
<style>
.dataTables_filter {
display: none; 
}
		...
		<div class="container-fluid">
					...
					<div class="box box-primary">
						...
						<form id="form1" action="" method="post" accept-charset="utf-8">
							...
							<div class="box-footer">
								<button type="button" id="search" name="search" value="search" style="margin-bottom:10px;" class="btn btn-danger btn-sm  checkbox-toggle"><i class="fa fa-search"></i> Kerko</button> <br>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="row">					
				<form id="attendanceForm" method="post">					
					...
					<button type="submit" id="saveAttendance" name="saveAttendance" value="Ruaj" style="margin-bottom:10px;" class="btn btn-danger btn-sm  pull-right checkbox-toggle hidden"><i class="fa fa-save"></i>Ruaj</button> <table id="studentList" class="table table-bordered table-striped hidden">
						<thead>
							<tr>
								<th>Emri</th>	
								<th>Mbiemri</th>
					...
					<input type="hidden" name="action" id="action" value="updateAttendanceLeksion" />
